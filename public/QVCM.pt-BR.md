> **Nota:** Tradução completa para o português em andamento. O conteúdo abaixo replica o texto original em inglês para manter a referência técnica enquanto refinamos a versão pt-BR.
